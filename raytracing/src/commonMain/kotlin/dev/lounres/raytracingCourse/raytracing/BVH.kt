...
internal fun BVH(figures: List<SceneObject<FiniteFigure>>): BVH = BVHImpl(figures)

private class BVHImpl(sceneObjects: List<SceneObject<FiniteFigure>>) : BVH {
    class Node(
    ...
    fun constructNode(sceneObjects: List<SceneObject<FiniteFigure>>): Node {
        val simpleNode = Node(
    ...
    override val root: Node = constructNode(sceneObjects)
